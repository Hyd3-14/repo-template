...
Dependency Reviewは共通baseの必須workflowには含めません。public repository、またはprivate repositoryでGitHub Code Security / GitHub Advanced Security等の利用条件を満たす場合だけ、生成先repoで追加しrequired check化してください。
